...
function gridster_setup() {
	...
	add_theme_support( 'post-thumbnails' );
	add_image_size( 'post-full', 550, 292, true);
	add_image_size( 'post-page', 550, 292, true );
...
// Google Font
	...
	wp_enqueue_style( 'Lato', 'http://fonts.googleapis.com/css?family=Lato:400,700,400italic', 'style' );
